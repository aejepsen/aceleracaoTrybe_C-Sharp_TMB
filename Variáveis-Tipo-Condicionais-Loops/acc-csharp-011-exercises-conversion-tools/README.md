...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/acc-csharp-011-exercises-conversion-tools.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd acc-csharp-011-exercises-conversion-tools`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-acc-csharp-011-exercises-conversion-tools`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-acc-csharp-011-exercises-conversion-tools`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/acc-csharp-011-exercises-conversion-tools/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/acc-csharp-011-exercises-conversion-tools/pulls) e confira que o seu _Pull Request_ está criado
...
Seu objetivo é converter o valor passado por parâmetro `strVariable` em um `int` e retornar esse valor.
...
Você deve verificar se a função consegue converter o valor de `string` em um `int` e retornar esse valor.
...
Seu objetivo é converter o valor passado por parâmetro `strVariable` em um `double` e retornar esse valor.
...
Você deve verificar se a função consegue converter o valor de `string` em um `double` e retornar esse valor.
...
Seu objetivo é converter o valor passado por parâmetro `intVariable` em uma `string` e retornar esse valor.
...
Você deve verificar se a função consegue converter o valor de `int` em uma `string` e retornar esse valor.
...
Seu objetivo é converter o valor passado por parâmetro `doubleVariable` em uma `string` e retornar esse valor.
...
Você deve verificar se a função consegue converter o valor de `double` em um `string` e retornar esse valor.
