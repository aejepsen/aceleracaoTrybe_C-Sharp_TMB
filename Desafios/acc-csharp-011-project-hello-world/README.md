...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/acc-csharp-011-project-hello-world.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd acc-csharp-011-project-hello-world`
  ...
  - Agora, crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-acc-csharp-011-project-hello-world`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-acc-csharp-011-project-hello-world`
...
<details>
  <summary>Crie o teste para o projeto em `src/ola-mundo.Test/OlaMundoTest.cs`.</summary><br />
...
- Verificar se é retornado a string exata "Olá, Mundo!"
